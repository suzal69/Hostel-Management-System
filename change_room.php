...
// Database connection check (assuming $conn is available from config.inc.php)
if (!isset($conn)) {
    // Handle error if connection failed in config.inc.php
    die("Database connection failed on page load.");
}

if ($hostel_id) {
    // 1. Fetch Hostel details securely
...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1><i class="fas fa-exchange-alt"></i> Change Room</h1>
            <p>Transfer students to different rooms within your hostel</p>
        </div>
        ...
        <div class="section">
            ...
            <div class="mail_grid_w3l">
                <form action="includes/change_room_new.inc.php" method="post">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="hostel" id="hostel" class="form-control" value="<?php echo htmlspecialchars($hostel_name); ?>" required="" readonly>
                        </div>
                        
                        <div class="form-group">
                            <label for="old_room_no">Current Room & Bed</label>
                            <input type="text" name="old_room_no" id="old_room_no" class="form-control" placeholder="Current Room & Bed" required="" readonly>
                        </div>
                        
                        <div class="form-group">
                            <label for="new_room_no">Select New Room</label>
                            <select name="new_room_no" id="new_room_no" required class="form-control">
                                <option value="">Select New Room</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="new_bed_no">Select Bed Number</label>
                            <select name="new_bed_no" id="new_bed_no" required class="form-control">
